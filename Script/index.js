...
descripcion:"Producto Unyclor, mantiene tu piscina limpia y cristalina.<br> Con su fórmula efectiva, es ideal para el mantenimiento regular.<br> Encontralo a un precio increible!",
  ...
  {
  id: "alguicida",
  nombre: "Alguicida Líquido 1 L Nataclor",
...
Características Destacadas del Clarificador Liquido 1 L Nataclor:<strong><br>
...
- Ideal para mantenimiento regular<br><br>`
    ...
    {
        id: "barrefondo-8.ruedas",
        nombre:"Limpiafondo de 8 ruedas fijas",
        imagen: "./Img/Productos/barrefondo-8-ruedas.jpg",
        descripcion:`Limpiafondos flexible 8 ruedas fijas.<br> Dispositivo para aspirar suciedad y residuos depositados en el fondo de la piscina.<br> 
        Para utilizarlo, se debe conectar la manguera flotante al acople de aspiración y un mango fijo o telescópico.<br>
Posee 8 ruedas fijas y asegura óptimo desempeño ya que se adapta a las pequeñas irregularidades de las superficie, su diseño le aporta resistencia a los impactos.`
    },
    {
        id: "boya1",
        nombre:"Boya",
        imagen: "./Img/Productos/boya1.jpg",
        descripcion:`Es un accesorio indispensable para una limpieza práctica y un optimo mantenimiento del agua en nuestra pileta.<br>
Es ideal para piletas grandes y de lona ya que pueden cargar hasta 2 kilos de pastillas de cloro.<br><br>
Boya Hongo para:<br>Pastillas de 200 gr. <br> Pastillas de 50 gr.`
    },
    {
        id: "clarificador-5l",
        nombre:"Clarificador 5 litros",
        imagen: "./Img/Productos/clarificador-5l.jpg",
       descripcion:`Características Destacadas del Clarificador Liquido 5 L Nataclor:<strong><br>
- Fórmula efectiva para agua transparente<br>
- Envase de 5 litros<br>
- Fácil de usar<br>
- Ideal para mantenimiento regular<br><br>
...
Aplicar 1 litro de SUPER Alguicida Nataclor previamente diluidos en un balde con un poco de agua cada 200.000 litros cada 5 a 7 días.`
    ...
    {
        id: "acople1",
        nombre: "Acople rápido",
        imagen:"./Img/Productos/acople.jpg",
        descripcion:`Acople giratorio liso Vulcano, con conexión combinada, para caños de diámetro ø 1 1/4" y ø 1 1/2", para conectar con la manguera de la piscina.<br>
        El acople giratorio liso de Vulcano permite conectar cualquier modelo de limpiafondos de uso residencial con mangueras flotantes de diámetro de 1 ½ y diámetro de 1 ¼. Está hecho de plástico duradero y su modo de uso es muy sencillo, ya que solo se requiere conectarlo al caño del limpiafondos y luego conectar la parte superior con la manguera para empezar a usarlo.`
    },  
    {
        id:"acople2",
        nombre:"Acople combinado",
        imagen:"./Img/Productos/acoplecombinado.jpg",
        descripcion:`Acople Rápido Vulcano combinado para manguera barrefondo.<br>
        Posee rosca macho de 1 1/2 y en el otro extremo un enchufe liso para manguera de 1 1/2 ó 1 1/4 indistintamente.<br>
- Se compone de 2 cuerpos y una tuerca con o'ring que los vincula.<br>
- Sirve para conectar en la piscina, en el skimmer, en la bomba o filtro.`
    },  
    {
        id:"boca-chica-hormigon",
        nombre:"Skimmer boca chica p/ hormigón",
        imagen:"./Img/Productos/bocachicahormigon.jpg",
        descripcion:`Toma superficial de agua Vulcano para piscinas de hormigón con boca de 20 cm de ancho y cuello de 265 cm de largo.<br>
        El skimmer filtra el agua y favorece el movimiento, garantizando así una limpieza correcta de la piscina, ya que la lámina superior del agua es la de menor contenido de cloro y en consecuencia junta mayor cantidad de microorganismos.<br>
        Construido en termoplástico ABS de color blanco de alta resistencia, está provisto de conexiones con uniones dobles formadas por bujes de rosca hembra de 1 1/2" para caños de polipropileno y lisos de ø50 mm para pegar caños de PVC.`
    }, 
    {
        id:"boca-chica-fv",
        nombre:"Skimmer boca chica FV",
       imagen:"./Img/Productos/skimmerchicofv.webp",
        descripcion:`Toma superficial de agua Vulcano para piscinas de fibra de vidrio con boca de 20 cm de ancho y cuello de 210 cm de largo. Su función es eliminar las impurezas flotantes en la piscina como hojas, papeles, cabellos, insectos, aceites bronceadores, residuos varios, etc.<br>
        <strong>Recomendaciones:</strong><br>
• Para seleccionar el skimmer adecuado es necesario tener en cuenta la superficie de la piscina y el ancho del misma. En piscinas residenciales se recomienda instalar un skimmer por cada 35m² de superficie.<br>
• Conectar siempre la boca prevista para el desborde.`
    },
    {
        id:"skimmer",
        nombre:"Skimmer boca ancha FV y Hormigón",
        imagen:"./Img/Productos/skimer.jpg",
        descripcion:`Toma superficial de agua Vulcano para piscinas de fibra de vidrio con boca de 38 cm de ancho y cuello de 265 cm de largo. Su función es eliminar las impurezas flotantes en la piscina como hojas, papeles, cabellos, insectos, aceites bronceadores, residuos varios, etc.<br>
El skimmer filtra el agua y favorece el movimiento, garantizando así una limpieza correcta de la piscina, ya que la lámina superior del agua es la de menor contenido de cloro y en consecuencia junta mayor cantidad de microorganismos.<br>
...
Construido en termoplástico ABS de color blanco de alta resistencia, está provisto de conexiones con uniones dobles formadas por bujes de rosca hembra de 1 1/2" para caños de polipropileno y lisos de ø50 mm para pegar caños de PVC.`
    ...
    {
        id:"bomba-1/2",
        nombre:"Bomba autocebante de 1/2HP.",
        imagen:"./Img/Productos/bomba1-2hp.jpg",
        descripcion:`Bomba autocebante para piscina BAP 050. Ofrece un óptimo rendimiento para responder a las exigencias del uso profesional. Es utilizada para la recirculación de caudales de agua principalmente en piscinas pequeñas y medianas.<br>

Cuenta con pre-filtro incorporado y canasto atrapa hojas de gran tamaño, tapa tipo mariposa de rápida apertura con un ¼ de giro y uniones dobles incorporadas. Provista con bujes para roscar de 1 ½” y de ø50 mm para pegar caños de PVC, para adaptarse a la cañería de la instalación.`
    },  
    {
        id:"bomba1hp",
        nombre:"Bomba autocebante de 1HP.",
        imagen:"./Img/Productos/bomba1hp.jpg",
        descripcion:`Bomba autocebante para piscina BAP 100. Ofrece un óptimo rendimiento para responder a las exigencias del uso profesional. Es utilizada para la recirculación de grandes caudales de agua principalmente en grandes piscinas.<br>

Cuenta con pre-filtro incorporado y canasto atrapa hojas de gran tamaño, tapa tipo mariposa de rápida apertura con un ¼ de giro y uniones dobles incorporadas. Provista con bujes para roscar de 1 ½” y de ø50 mm para pegar caños de PVC, para adaptarse a la cañería de la instalación.`
    },  
    {
        id:"bomba-3/4",
        nombre:"Bomba autocebante de 3/4HP.",
        imagen:"./Img/Productos/bomba3-4hp.jpg",
        descripcion:`Bomba autocebante para piscina BAP 075. Ofrece un óptimo rendimiento para responder a las exigencias del uso profesional. Es utilizada para la recirculación de caudales de agua principalmente en piscinas medianas.<br>

Cuenta con pre-filtro incorporado y canasto atrapa hojas de gran tamaño, tapa tipo mariposa de rápida apertura con un ¼ de giro y uniones dobles incorporadas. Provista con bujes para roscar de 1 ½” y de ø50 mm para pegar caños de PVC, para adaptarse a la cañería de la instalación.`
    },  
    {
        id:"boca-river-boya",
        nombre:"Boya Futbol Boca-River",
        imagen:"./Img/Productos/boyafutbol.jpg",
        descripcion:`La boya dosificadora es un recipiente que sirve para colocar la pastilla de cloro que en contacto con el agua y por diferencia de presión diluye lentamente la pastilla de cloro. Son fabricadas en PVC.`
    }, 
    {
        id:"canasto-bomba",
        nombre:"Canasto para Bomba",
        imagen:"./Img/Productos/canastoBomba.jpg",
        descripcion:`Canasto BAE 5L. Esta pieza es un repuesto original, directo de fábrica. El empleo de repuestos ajenos a la marca afecta la calidad y desempeño del mismo.<br>
Las piezas están diseñadas y probadas para brindar seguridad, rendimiento y confiabilidad a nuestros clientes.`
    },
    {
        id:"canastos-bomba",
        nombre:"Canastos c/ manija para bomba",
        imagen:"./Img/Productos/canastorectang.png",
        descripcion:`Canasto BAT. Esta pieza es un repuesto original, directo de fábrica. El empleo de repuestos ajenos a la marca afecta la calidad y desempeño del mismo.<br>
Las piezas están diseñadas y probadas para brindar seguridad, rendimiento y confiabilidad a nuestros clientes.`
    },
    {
        id:"canasto-skimmer",
        nombre:"Canasto para skimmer",
        imagen:"./Img/Productos/canastoskimmer.png",
        descripcion:`Canasto skimmer con manija. Esta pieza es un repuesto original, directo de fábrica. El empleo de repuestos ajenos a la marca afecta la calidad y desempeño del mismo.<br>
Las piezas están diseñadas y probadas para brindar seguridad, rendimiento y confiabilidad a nuestros clientes.`
    },
    {
        id: "cepillo46cm",
        nombre:"Cepillo limpiafondo curvo de 46cm",
        imagen:"./Img/Productos/curvo46cm.jpg",
        descripcion:`Cepillo curvo Vulcano. <br>Cuerpo plástico de 46 cm de largo y 4 hileras de cerdas de polipropileno; utilizado para limpieza de paredes en piscinas pintadas y revestidas.`
    },
    {
        id:"filtro-papel",
        nombre:"Cartucho Filtro de papel",
        imagen:"./Img/Productos/filtropapel.jpg",
        descripcion:`Filtro descartable de papel filtrante de ø75 mm.<br> Su minúscula malla permite buen flujo del agua, obstruyendo el paso de partículas incluso diminutas, lo que garantiza que el proceso de filtrado resulte en agua limpia y cristalina.`
    },
    {
        id:"flexible8r",
        nombre:"Limpiafondo flexible de 8 ruedas",
       imagen:"./Img/Productos/Flexible8R.jpg",
        descripcion:`Limpiafondos flexible 8 ruedas fijas Vulcano. Dispositivo para aspirar suciedad y residuos depositados en el fondo de la piscina. Para utilizarlo, se debe conectar la manguera flotante al acople de aspiración y un mango fijo o telescópico.<br>
Posee 8 ruedas fijas y asegura óptimo desempeño ya que se adapta a las pequeñas irregularidades de las superficie, su diseño le aporta resistencia a los impactos.`
    },
    {
        id:"flota",
        nombre:"Flota-flota",
        imagen:"./Img/Productos/flota.jpg",
        descripcion:`Flota Flota  de 65mm x 1,70 Mts, una opción ideal para disfrutar de la piscina o la playa con total seguridad y diversión. <br>Este flotador, es súper duradero, lo que garantiza su resistencia y durabilidad en el tiempo. Además, es completamente seguro para su uso, ya que está fabricado con materiales no tóxicos.<br>
El Flota Flota viene en varios colores, lo que permite elegir el que más te guste o el que mejor se adapte a tu estilo. Con un diámetro de 65 cm, este flotador es lo suficientemente grande como para proporcionar una flotabilidad adecuada, pero también lo suficientemente compacto como para llevarlo fácilmente a cualquier lugar.`
    },
    {
        id:"grava",
        nombre:"Grava para filtro fina y gruesa x25kg.",
        imagen:"./Img/Productos/grava1.webp",
        descripcion:`Piedra fina: sirve como soporte para el cuarzo, ya que no permite que el mismo pase.<br>
Piedra gruesa: sirve principalmente como relleno.<br>

<strong>Recomendaciones:</strong><br><br>
• El cambio de carga filtrante en el tanque se debe realizar con cuidado no modificar la posición normal de trabajo del tubo colector, colector y picos.<br>
• Al introducir la carga, esta no debe ingresar en el tubo colector (se recomienda tapar la boca del mismo previo a esta operación).`
    },
    {
        id:"mangoestriado1.5",
    ...
    {
        id:"mango2.4m",
        nombre:"Mango telescopico 2.4m",
        imagen:"./Img/Productos/mangotelescopico.jpg",
        descripcion:`Mango telescópico Vulcano. Fabricado de aluminio anodizado estriado, cuenta con ø32 mm y largo total de 2,40 m, con tuerca de ajuste y traba. Sus características constructivas, brindan resistencia mecánica y a la corrosión, permitiendo utilizarlo bajo altas exigencias.<br><br>
...
Está compuestos por 2 tubos que encajan uno en el interior del otro, con posibilidad de desplazamiento. El largo del mismo se ajusta fácilmente y se traba por medio de su tuerca y boquilla correspondiente.`
    ...
    {
        id:"mango4.8m",
        nombre:"Mango telescopico 4.8m",
        imagen:"./Img/Productos/mangotelescopico.jpg",
        descripcion:`Mango telescópico Vulcano. Fabricado de aluminio anodizado estriado, cuenta con ø32 mm y largo total de 4,80 m, con tuerca de ajuste y traba. Sus características constructivas, brindan resistencia mecánica y a la corrosión, permitiendo utilizarlo bajo altas exigencias.<br><br>
Está compuestos por 2 tubos que encajan uno en el interior del otro, con posibilidad de desplazamiento. El largo del mismo se ajusta fácilmente y se traba por medio de su tuerca y boquilla correspondiente.`
    },
    {
        id:"manguera1/2",
...
No se desarma, es totalmente hermética, debido a su confección, y flota sin dificultad.`
     ...
     {
        id:"manometro",
        nombre:"Manometro filtros piscina - Rosca 1/4″.",
        imagen:"./Img/Productos/Manometro.webp",
        descripcion:`Manometro de escala colorimétrica: 0 - 4 kg/cm.
Diámetro: 50 mm.`
    },
    {
        id:"medialuna-liviano",
        nombre:"Barrefondo medialuna liviano",
        imagen:"./Img/Productos/medialunaPesado.jpg",
        descripcion:`Limpiafondos medialuna liviano Vulcano.<br> Dispositivo para aspirar suciedad y residuos depositados en el fondo de la piscina. Para utilizarlo, se debe conectar la manguera flotante al acople de aspiración y un mango fijo o telescópico.<br><br>
El modelo medialuna liviano posee cepillos de polipropileno fijos, su diseño y peso lo transforman en la mejor opción para limpiar escaleras y formas irregulares, resulta óptimo para piscinas pequeñas/medianas.`
    },
     {
        id:"medialuna-pesado",
        nombre:"Barrefondo medialuna pesado",
        imagen:"./Img/Productos/medialunaPesado.jpg",
        descripcion:`Limpiafondos medialuna pesado Vulcano.<br> Dispositivo para aspirar suciedad y residuos depositados en el fondo de la piscina. Para utilizarlo, se debe conectar la manguera flotante al acople de aspiración y un mango fijo o telescópico.<br>
El modelo medialuna pesado posee cepillos de polipropileno fijos, su diseño y peso lo transforman en la mejor opción para limpiar escaleras y formas irregulares.<br><br>`
    },
     {
        id:"p200",
        nombre:"Pastillas de cloro multiacción",
        imagen:"./Img/Productos/p200.jpg" ,
        descripcion:` Eficaz bactericida de disolución lenta con propiedades desinfectantes, bactericidas, alguicidas y clarificantes. Ideal para mantenimiento esporádico de la piscina; no incrementa la alcalinidad del agua, se mantiene estable ante la acción del sol y es de alto poder residual. Presentación 1 kg.`
    },
     {
        id:"profesionalbolsa",
        nombre:"Saca hojas Profesional c/ bolsa",
        imagen:"./Img/Productos/profesionalconbolsa.jpg",
        descripcion:`Sacahojas plástico de 370 x 490 mm para mango de ø32 mm. Posee red con bolsa, pensado para colectar impurezas del fondo de la piscina, cuenta con conector reforzado y canto en forma de pala para hacer más sencilla la recolección.`
    },
     {
        id:"shojasreforzado",
        nombre:"Saca hojas reforzado p/ mango 19mm.",
        imagen:"./Img/Productos/sacahojasreforzado.jpg",
        descripcion:`Sacahojas plástico de 410 x 290 mm con mango fijo de aluminio liso de ø19 mm. Posee red con bolsa, pensado para colectar impurezas del fondo de la piscina, cuenta con conector reforzado y canto en forma de pala para hacer más sencilla la recolección.`
    },
     {
        id:"sinbichos",
        nombre:"Sin Bichos",
        imagen:"./Img/Productos/sinbichos.jpg",
        descripcion:`El producto ideal para combatir los molestos bichos de tu pileta.<br>
Elimina Cucarachas de agua, barquero de agua y otros insectos acuáticos.<br><br>
<b>No Toxico!</b>`
    },
    {
        id:"union-doble",
        nombre:"Union doble",
        imagen:"./Img/Productos/UnionDoble.webp",
        descripcion:`Unión doble flexible azul de PVC para manguera flotante de diámetro ø 1 1/4" y ø 1 1/2" Vulcano.`
    },
     {
        id:"terminal1/2",
        nombre:"Terminal Roscado 1/2",
        imagen:"./Img/Productos/terminalroscado1-2.jpg",
        descripcion:`Terminal flexible roscada Vulcano para manguera flotante de ø1 1/2".`
    },
     {
        id:"terminal1/4",
        nombre:"Terminal Roscado 1/4",
        imagen:"./Img/Productos/terminalroscado1-4.jpg",
        descripcion:`Terminal flexible roscada Vulcano para manguera flotante de ø1 1/4".`
    },
     {
        id:"tomafondo",
        nombre:"Toma de fondo",
        imagen:"./Img/Productos/tomadefondo.jpg",
        descripcion:`Diseñada para ofrecer excelente acción de succión y drenaje, evitando la formación de remolinos.<br>
Cuenta con 2 bocas, una lateral para aspiración y otra inferior para drenaje. La boca de aspiración se conectará a la electrobomba, mientras que la de drenaje debe mantenerse normalmente cerrada con el tapón colocado, el retiro del mismo permitirá la salida de los últimos restos de agua de la piscina.<br>
<b>Características técnicas</b><br>
• Cuerpo de poliestireno de alto impacto.<br>
• Fijación de tapa y rejilla con tornillos Parker.<br>
• 2 tomas de rosca hembra de 2".`
    },
     {
        id:"triangular",
        nombre:"Barrefondo Triangular Pesado",
        imagen:"./Img/Productos/Triangular.jpg",
        descripcion:`Limpiafondos triangular Vulcano.<br> Dispositivo para aspirar suciedad y residuos depositados en el fondo de la piscina. Para utilizarlo, se debe conectar la manguera flotante al acople de aspiración y un mango fijo o telescópico.<br>
El modelo triangular es robusto y pesado para mayor eficiencia en la remoción de suciedad del fondo, posee cepillos de polipropileno intercambiables y su diseño permite limpiar fácilmente esquinas y recodos.`
    },
      {
      id:"casilla",
      nombre:"Casilla para filtro VC-50",
      imagen: "./Img/Productos/Casilla para filtro VC-50.webp",
      descripcion:"Casilla Vulcano para filtro VC-50.<br> Fabricada de polietileno rotomoldeado con orificio inferior para evitar inundaciones. Ideada para ser enterrada y dejar solo visible la tapa, en su interior encontramos los alojamientos para la fijación del filtro y la electrobomba. Este centro compacto de instalación, se convierte en una excelente opción para la disminución de tiempo y procesos, simplificando y haciendo más económico el proyecto.",
    },
     {
        id:"vc100",
        nombre:"Filtro VC 100",
        imagen:"./Img/Productos/vc100.jpg",
        descripcion:`Filtro VC-100 Vulcano de ø690 mm para piscinas de hasta 130.000 litros. Diseñado para eliminar las impurezas (mayores a 20 µ) que llegan al agua por medio del viento, lluvia o el uso. Fabricado por soplado en una sola pieza con materiales de alta resistencia a la corrosión, este equipo garantiza una larga vida útil con óptimo funcionamiento.<br>
        Cuenta con uniones rápidas para pegar y roscar y Multiválvula selectora de 6 vías para las funciones de filtrado, retrolavado, desagote, enjuague, centrifugado y cierre.
Contamos con una completa línea de repuestos disponibles para la reparación y mantenimiento de este equipo.`
    },
     {
        id:"vc20",
        nombre:"Filtro VC 20",
        imagen:"./Img/Productos/vc20.jpg",
        descripcion:`Filtro VC-20 Vulcano de ø360 mm para piscinas de hasta 35.000 litros. Diseñado para eliminar las impurezas (mayores a 20 µ) que llegan al agua por medio del viento, lluvia o el uso. Fabricado por soplado en una sola pieza con materiales de alta resistencia a la corrosión, este equipo garantiza una larga vida útil con óptimo funcionamiento.<br>
Cuenta con uniones rápidas para pegar y roscar y Multiválvula selectora de 6 vías para las funciones de filtrado, retrolavado, desagote, enjuague, centrifugado y cierre.`
    },
     {
        id:"vc50",
        nombre:"Filtro VC 50",
        imagen:"./Img/Productos/vc50.jpg",
        descripcion:`Filtro VC-50 Vulcano de ø540 mm para piscinas de hasta 80.000 litros. Diseñado para eliminar las impurezas (mayores a 20 µ) que llegan al agua por medio del viento, lluvia o el uso. Fabricado por soplado en una sola pieza con materiales de alta resistencia a la corrosión, este equipo garantiza una larga vida útil con óptimo funcionamiento.<br>
Cuenta con uniones rápidas para pegar y roscar y Multiválvula selectora de 6 vías para las funciones de filtrado, retrolavado, desagote, enjuague, centrifugado y cierre.`
    },
     {
        id:"vercelx4",
        nombre:"Vercel x4L.",
        imagen:"./Img/Productos/vercelx4.jpg",
        descripcion:`<b>ALGUICIDA, FUNGICIDA Y CLARIFICADOR</b><br>
Este excelente producto está formulado de manera que el consumidor solo tiene que calcular el volumen de la piscina, midiendo largo, ancho y la altura media hasta el pelo de agua, hacer el cálculo (L x A x 1000)/Hm, lo cual nos da la cantidad de litros de la pileta, agregando la cantidad necesaria según recomendamos:<br>
- Con agua nueva se debe adicionar 1 litro del producto cada 15.000 litros de agua.<br>
- Con agua en uso 1 litro del producto cada 30.000 litros como refuerzo cada 21 días (3 semanas).<br>`
     },
     {
        id:"vercel1l",
        nombre:"Vercel 1L",
        imagen:"./Img/Productos/vercel1L.webp",
        descripcion:`<b>ALGUICIDA, FUNGICIDA Y CLARIFICADOR</b><br>
Este excelente producto está formulado de manera que el consumidor solo tiene que calcular el volumen de la piscina, midiendo largo, ancho y la altura media hasta el pelo de agua, hacer el cálculo (L x A x 1000)/Hm, lo cual nos da la cantidad de litros de la pileta, agregando la cantidad necesaria según recomendamos:<br>
- Con agua nueva se debe adicionar 1 litro del producto cada 15.000 litros de agua.<br>
- Con agua en uso 1 litro del producto cada 30.000 litros como refuerzo cada 21 días (3 semanas).<br>`
    },
     {
        id:"virola",
        nombre:"Virola",
        imagen:"./Img/Productos/virola.jpg",
        descripcion:`Virola Vulcano para piscina de fibra de vidrio. <br>Posee aro desmontable blanco y cuerpo de ø50 mm para pegar. Se trata de un dispositivo de aspiración que se instala por debajo del nivel de agua de la piscina y se utiliza para conectar la manguera del limpiafondos, permitiendo aspirar la suciedad de todo el fondo de la pileta.`
    },
    {
        id:"bordecurvo",
        nombre: "Borde Curvo",
        imagen:"./Img/Productos/Losetas/BORDE CURVO VIATTURI Ø 2 M 54,5 x 28,5 cm.jpg",
        descripcion:`Designación: B-V Ø 2 BORDE VIATTTURI DIÁMETRO 2 mts.<br>
Medidas nominales: 54,5 x 28,5 cm.<br>
Peso (kg): 11.<br>
Piezas: 1.<br>
Cantidad por pallet: 28.<br>`
    },
    {
        id:"borderadio",
        nombre:"Borde Radio 500",
        imagen:"./Img/Productos/Losetas/borde-radio-500-blanco-545x545-monaco.png",
        descripcion:`COLOR: BLANCO.
MEDIDA (CM): 54,5 x 54,5.
TIPOLOGÍA: LOSETA ATERMICA.
PESO (KG): 23 KG.`
    },
 
    {
        id:"bordel",
        nombre:"Borde L",
        imagen:"./Img/Productos/Losetas/BordeL.jpg" ,
        descripcion:`Esta línea cuenta con un marcado estilo minimalista siguiendo las últimas tenencias de la construcción. La línea L se presenta en 2 medidas: 50x50 y 50x25 cm. Ambos modelos cuentan con idéntico desarrollo frontal mientras que la diferencia se establece en la profundidad de cada pieza.<br>
         Tecnología:<br>
          -Resistente.<br>
           -Atérmico.<br>
            -Anti réflex.<br>
    ...
    },
    {
        id:"esquinero",
        nombre:"Esquinero",
        imagen:"./Img/Productos/Losetas/esquinero.jpg",
        descripcion:`Absorben hasta 15° C menos de temperatura que otras superficies por ser fabricados en un 100% con material atérmico.<br>
Únicos certificados por CECOVI (Centro de Investigación y Desarrollo para la Construcción y la Vivienda de la Universidad Tecnológica Nacional) para las piezas color Blanco y Marfil.`
    },
    {
        id:"rinconcurvo",
        nombre:"Rincón curvo (A y B)",
        imagen:"./Img/Productos/Losetas/rinconCurvo.jpg",
        descripcion:`Designación: B-VRC BORDE VIATTURI RINCÓN CURVO (A Y B).<br>
Medidas nominales: 52 x 54 cm.<br>
Peso (kg): 12.5.<br>
Piezas: 1.<br>
Cantidad por pallet: 40.`
    },
     {
        id:"solarium",
        nombre:"Solarium 50x50",
        imagen:"./Img/Productos/Losetas/solarium50x50.webp",
        descripcion:`Medidas: 50x50x3 cm.<br>
Apto para exterior: Sí.<br>
Rendimiento: 0.5 m².<br>
Peso de cada unidad: 15 kg.<br>
Peso del m2: 60 kg.`
    },
     {
    nombre: "Acido muriático x5L.",
